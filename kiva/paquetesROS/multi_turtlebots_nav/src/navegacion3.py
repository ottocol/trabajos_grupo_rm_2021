...
if __name__ == "__main__":
    rospy.init_node('movebase3')
    cliente3 = ClienteMoveBase(3)
    result=cliente3.moveTo(1,0,0,0,0.5,0.5)
    if (result):
        result2=cliente3.moveTo(2,0,0,0,0.5,0.5)
    else:
        print "Error, robot3 no puede llegar"
