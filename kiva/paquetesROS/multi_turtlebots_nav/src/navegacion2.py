...
if __name__ == "__main__":
    rospy.init_node('movebase2')
    cliente2 = ClienteMoveBase(2)
    result=cliente2.moveTo(0,1,0,0,0.5,0.5)
    if (result):
        result2=cliente2.moveTo(-1,1,0,0,0.5,0.5)
    else:
        print "Error, robot2 no puede llegar"
