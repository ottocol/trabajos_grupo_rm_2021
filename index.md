...
## Creación de un robot móvil personalizado a partir de un fichero URDF **(5 puntos)**
...
## Uso de aprendizaje por refuerzo para robótica móvil **(10 puntos)**
...
## Deep learning en robótica móvil **(8 puntos)**
...
## Drones y robots voladores **(5 puntos)**
...
## *Curiosity*, el robot explorador de Marte **(2 puntos)**
...
## Drones en el ámbito militar **(2 puntos)**
...
## Control móvil de robots drones **(5 puntos)**
...
## Drones y sus aplicaciones actuales **(8 puntos)**
...
## Redes neuronales en robótica móvil **(1 punto)**
### Anastasiia Karpenko

- [Documento pdf](redes_neuronales/trabajo.pdf)

## Robótica submarina **(3 puntos)**
...
## Optimización de Trayectorias para la locomoción de robots con patas **(9 puntos)**
...
## Localización y control de un dron **(4 puntos)**
...
## Robots voladores. Drones **(5 puntos)**
...
## Estudio de los Mars Exploration Rover: *hardware* y algoritmos **(5 puntos)**
