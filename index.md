...
> IMPORTANTE: las votaciones son provisionales a fecha de 8 de febrero, todavía quedan algunos grupos por votar. Los puntos que aparecen son los asignados por los compañeros, no se corresponden con la nota final

## Vehículos no tripulados. Robot Kiva **(9 puntos)**
...
## Creación de un robot móvil personalizado a partir de un fichero URDF **(9 puntos)**
...
## Uso de aprendizaje por refuerzo para robótica móvil **(16 puntos)**
...
## Deep learning en robótica móvil **(11 puntos)**
...
## Drones y robots voladores **(10 puntos)**
...
## *Curiosity*, el robot explorador de Marte **(5 puntos)**
...
## Drones en el ámbito militar **(7 puntos)**
...
## Control móvil de robots drones **(9 puntos)**
...
## Drones y sus aplicaciones actuales **(13 puntos)**
...
## Redes neuronales en robótica móvil **(8 puntos)**
### Anastasiia Karpenko

- [Documento pdf](redes_neuronales/trabajo.pdf)

## Robótica submarina **(7 puntos)**
...
## Optimización de Trayectorias para la locomoción de robots con patas **(15 puntos)**
...
## Localización y control de un dron **(8 puntos)**
...
## Robots voladores. Drones **(7 puntos)**
...
## Estudio de los Mars Exploration Rover: *hardware* y algoritmos **(9 puntos)**
